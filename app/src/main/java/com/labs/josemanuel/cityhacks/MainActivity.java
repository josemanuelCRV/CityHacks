package com.labs.josemanuel.cityhacks;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<PropuestasPOJOModel> propuestaslList =
                PropuestasUtils.getDataSet(MainActivity.this);
        AdaptadorPropuestasRecycler adapter =
                new AdaptadorPropuestasRecycler(propuestaslList, MainActivity.this);
        ...
        if (savedInstanceState == null) {
            getFragmentManager().beginTransaction()
                    .add(R.id.fragment_main, new Fragment(), "MainFragment")
                    .commit();
        }
